...
from s3prl.utility.helper import (
    backup,
    get_time_tag,
    hack_isinstance,
    is_leader_process,
...
def get_downstream_args():
    ...
    parser.add_argument(
        "--push_to_hf_hub",
        default=False,
        help="Push all files in experiment directory to the Hugging Face Hub. To use this feature you must set HF_USERNAME and HF_PASSWORD as environment variables in your shell",
    )
    parser.add_argument(
        "--hf_hub_org",
